...
export const Globe_Stroke2_Corner0_Rounded = forwardRef<Svg, Props>(
  function GlobeImpl(props, ref) {
...
export const Earth_Stroke2_Corner0_Rounded = forwardRef<Svg, Props>(
  function EarthImpl(props, ref) {
    const {fill, size, style, ...rest} = useCommonSVGProps(props)
    return (
      <Svg
        fill="none"
...
export const Earth_Stroke2_Corner2_Rounded = forwardRef<Svg, Props>(
  function EarthImpl(props, ref) {
    const {fill, size, style, ...rest} = useCommonSVGProps(props)
    return (
      <Svg
